...
Source0  : https://www.mpg123.de/download/mpg123-1.27.0.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.27.0.tar.bz2.sig
...
%prep
%setup -q -n mpg123-1.27.0
cd %{_builddir}/mpg123-1.27.0
pushd ..
cp -a mpg123-1.27.0 build32
popd
pushd ..
cp -a mpg123-1.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620398447
...
cp %{_builddir}/mpg123-1.27.0/COPYING %{buildroot}/usr/share/package-licenses/mpg123/5b0649acc39fef80cccbf195783245940f951fc5
pushd ../build32/
%make_install32
