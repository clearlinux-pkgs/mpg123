...
Source0  : https://www.mpg123.de/download/mpg123-1.27.2.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.27.2.tar.bz2.sig
...
%prep
%setup -q -n mpg123-1.27.2
cd %{_builddir}/mpg123-1.27.2
pushd ..
cp -a mpg123-1.27.2 build32
popd
pushd ..
cp -a mpg123-1.27.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620659517
...
cp %{_builddir}/mpg123-1.27.2/COPYING %{buildroot}/usr/share/package-licenses/mpg123/5b0649acc39fef80cccbf195783245940f951fc5
pushd ../build32/
%make_install32
...
/usr/lib64/haswell/libmpg123.so.0.46.1
