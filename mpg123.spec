...
Source0  : https://www.mpg123.de/download/mpg123-1.32.10.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.32.10.tar.bz2.sig
...
%setup -q -n mpg123-1.32.10
cd %{_builddir}/mpg123-1.32.10
pushd ..
cp -a mpg123-1.32.10 build32
popd
pushd ..
cp -a mpg123-1.32.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735088253
