...
Source0  : https://www.mpg123.de/download/mpg123-1.33.0.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.33.0.tar.bz2.sig
...
%setup -q -n mpg123-1.33.0
cd %{_builddir}/mpg123-1.33.0
pushd ..
cp -a mpg123-1.33.0 build32
popd
pushd ..
cp -a mpg123-1.33.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749576637
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmpg123.so.0.49.3
/V3/usr/lib64/libout123.so.0.5.2
...
/usr/lib64/libmpg123.so.0.49.3
/usr/lib64/libout123.so.0
/usr/lib64/libout123.so.0.5.2
...
/usr/lib32/libmpg123.so.0.49.3
/usr/lib32/libout123.so.0
/usr/lib32/libout123.so.0.5.2
