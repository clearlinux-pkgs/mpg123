...
Source0  : https://www.mpg123.de/download/mpg123-1.32.6.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.32.6.tar.bz2.sig
...
%prep
%setup -q -n mpg123-1.32.6
cd %{_builddir}/mpg123-1.32.6
pushd ..
cp -a mpg123-1.32.6 build32
popd
pushd ..
cp -a mpg123-1.32.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712324808
