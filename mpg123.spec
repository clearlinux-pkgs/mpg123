...
Source0  : https://www.mpg123.de/download/mpg123-1.32.3.tar.bz2
Source1  : https://www.mpg123.de/download/mpg123-1.32.3.tar.bz2.sig
...
%prep
%setup -q -n mpg123-1.32.3
cd %{_builddir}/mpg123-1.32.3
pushd ..
cp -a mpg123-1.32.3 build32
popd
pushd ..
cp -a mpg123-1.32.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696268559
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmpg123.so.0.48.1
/V3/usr/lib64/libout123.so.0.5.0
/V3/usr/lib64/libsyn123.so.0.2.2
